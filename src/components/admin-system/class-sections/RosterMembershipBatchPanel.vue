...
const studentIdsInput = computed({
  get: () =>
    Array.isArray(model.value.studentProfileIds) ? model.value.studentProfileIds.join(', ') : '',
  set: (value) => {
    ...
    <ElForm :model="model" label-position="top">
      <div class="grid gap-4 md:grid-cols-3">
        <ElFormItem
          ...
          :error="fieldErrors.effective_start_date?.[0]"
        >
          <ElDatePicker
        ...
        <ElFormItem
          ...
          :error="fieldErrors.student_profile_ids?.[0]"
        >
