export const authMessages = {
  ...
  schoolSelection: {
    ...
    filteredEmpty: 'No active schools match these filters.',
    loading: 'Loading active schools',
    retry: 'Try again',
    refresh: 'Refresh active schools',
    manageSchools: 'Open School administration',
    nameLabel: 'School name',
    namePlaceholder: 'Search by school name',
    inepLabel: 'INEP code',
    inepPlaceholder: 'Search by INEP code',
    search: 'Search',
    clear: 'Clear',
    identity: 'INEP {inep} · {city}, {state}',
    choiceLabel: 'Select {name}, INEP {inep}, {city}, {state}',
    errors: {
      validation: 'Review the filters and try again.',
      unauthorized: 'Your session ended. Sign in again.',
      forbidden: 'Only an active System Administrator can choose a school.',
      'inactive-school': 'That school is inactive. Refresh and choose another school.',
      'inactive-context': 'That school is inactive. Refresh and choose another school.',
      'tenant-mismatch': 'The backend could not confirm that exact school context.',
      'expired-session': 'Your session expired. Sign in again.',
      conflict: 'The school changed while you were selecting it. Refresh and retry.',
      unavailable: 'School selection is temporarily unavailable.',
      'temporary-unavailable': 'School selection is temporarily unavailable.',
      'context-invalidated': 'The previous school context ended. Choose an active school.',
      'restoration-failed': 'The saved school could not be restored. Choose another school.',
    },
  },
  state: {
